...
//
int encode41_sess1pkt_cmd10r_pos1_recurs2(char *buf, int buf_limit_len) {
  struct blob_s blob;
  int buf_len;
  int blob_count;
...
int encode41_sess1pkt_cmd10r_pos1_recurs(char *buf, int buf_limit_len) {
  struct blob_s blob;
  uint session_id;
  uint session_cmd;
  int buf_len;
  ...
  intbuf_len = encode41_sess1pkt_cmd10r_pos1_recurs2(intbuf, sizeof(intbuf));
  blob.obj_type = 0x04;
  blob.obj_index = 0x04;
  blob.obj_data = 0;
...
int encode41_sess1pkt_cmd10r_pos1(char *buf, int buf_limit_len) {
  struct blob_s blob;
  uint session_id;
  uint session_cmd;
  int buf_len;
  ...
  intbuf_len = encode41_sess1pkt_cmd10r_pos1_recurs(intbuf, sizeof(intbuf));
  blob.obj_type = 5;
  blob.obj_index = 3;
  blob.obj_data = 0;
  blob.data_ptr = (int) intbuf;
