...
//
int encode41_sess1pkt_cmd13r_recurs4(char *buf, int buf_limit_len) {
  struct blob_s blob;
  uint session_id;
  uint session_cmd;
  int buf_len;
...
int encode41_sess1pkt_cmd13r_recurs3(char *buf, int buf_limit_len) {
  struct blob_s blob;
  uint session_id;
  uint session_cmd;
  int buf_len;
...
int encode41_sess1pkt_cmd13r_recurs2(char *buf, int buf_limit_len) {
  struct blob_s blob;
  int buf_len;
  int blob_count;
  ...
  intbuf_len = encode41_sess1pkt_cmd13r_recurs3(intbuf, sizeof(intbuf));
  blob.obj_type = 5;
  blob.obj_index = 0x14;
  blob.obj_data = 0;
  ...
  intbuf2_len = encode41_sess1pkt_cmd13r_recurs4(intbuf2, sizeof(intbuf2));
  blob.obj_type = 5;
  blob.obj_index = 0x2F;
  blob.obj_data = 0;
...
int encode41_sess1pkt_cmd13r_recurs(char *buf, int buf_limit_len) {
  struct blob_s blob;
  uint session_id;
  uint session_cmd;
  int buf_len;
  ...
  intbuf_len = encode41_sess1pkt_cmd13r_recurs2(intbuf, sizeof(intbuf));
  blob.obj_type = 4;
  blob.obj_index = 0x04;
  blob.obj_data = 0;
  blob.data_ptr = (int) intbuf;
...
int encode41_sess1pkt_cmd13r(char *buf, int buf_limit_len) {
  struct blob_s blob;
  uint session_id;
  uint session_cmd;
  int buf_len;
  ...
  intbuf_len = encode41_sess1pkt_cmd13r_recurs(intbuf, sizeof(intbuf));
  blob.obj_type = 5;
  blob.obj_index = 3;
  blob.obj_data = 0;
  blob.data_ptr = (int) intbuf;
