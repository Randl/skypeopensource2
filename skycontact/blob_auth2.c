...
int encode41_auth2pkt(char *buf, int buf_limit_len) {
  struct blob_s blob;
  uint session_id;
  uint session_cmd;
  int buf_len;
  ...
  second_len = encode41_auth2pkt_second(buf + buf_len, buf_limit_len);
...
int encode41_auth2pkt_second(char *buf, int buf_limit_len) {
  struct blob_s blob;
  uint session_id;
  uint session_cmd;
  int buf_len;
  ...
  // blob3 -- some ... hostid2 or unique session garbage data?
  blob.obj_type = 0;
  blob.obj_index = 0x0E;
...
"\x41\x04\x00\x00\x8E\x2F\x00\x02\x03\x03\x04\x74\x68\x65\x6D\x61"
"\x67\x69\x63\x66\x6F\x72\x79\x6F\x75\x00\x04\x05\x10\xFC\x9D\x77"
"\xE4\xA7\x40\x93\xD5\x75\xA4\xC3\xFA\x27\x4A\x4B\x6A\x41\x03\x03"
"\x04\x74\x68\x65\x6D\x61\x67\x69\x63\x66\x6F\x72\x79\x6F\x75\x00"
"\x03\x0D\x30\x2F\x36\x2E\x31\x36\x2E\x30\x2E\x31\x30\x2F\x2F\x00"
"\x00\x0E\xFA\xD6\xD3\xF9\x05"
;
