  ...
  *(u32 *) (ctx + 8) >>= 1;
  ...
  if (*(u32 *) (ctx + 0x316) != 0) {
    while (1) {
      ...
      if (t3 == 2) {
        v24 = **(u8 ***) (ctx + 0x1F6);
        unpack_42_2_715200(the_thing,
                           v24[0] + ((v24[1] + ((v24[2] + (v24[3] << 8)) << 8)) << 8),
                           v24[4] + (v24[5] << 8));
      }
      else {
        if (t3 == 4) {
...
u32 *unpack_41_0_715D70(u32 *the_thing, u32 the_dword) {
  ...
  memcpy((void *) (16 * the_dword + *the_thing + 16),
         (void *) (16 * the_dword + *the_thing),
         16 * (*(the_thing + 2) - the_dword));
  v7 = (u32 *) *the_thing;
  ++*(the_thing + 2);
...
u32 unpack_41_715680(u8 **packed_blob, u32 *the_thing, u32 *packed_bytes, u32 max_depth, u32 *list_size) {
  ...
  switch (*the_thing) {
    ...
    case 3:
      ...
      if (!v12
          || (v15 = (u32) (v12 - *packed_blob + 1), the_thing[3] = (u32) (v12 - *packed_blob + 1), *list_size < v15))
        return 0;
      *list_size -= v15;
      ...
      *packed_bytes -= the_thing[3];
      return 1;
    case 4:
      if (!unpack_41_dword_896070(the_thing + 3, packed_blob, packed_bytes) || (*packed_bytes < the_thing[3])
