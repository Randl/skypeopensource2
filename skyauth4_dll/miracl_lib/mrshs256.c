...
static void shs_transform(sha256 *sh) { /* basic transformation step */
...
void shs256_init(sha256 *sh) { /* re-initialise */
  int i;
...
void shs256_process(sha256 *sh, int byte) { /* process the next message byte */
  int cnt;
...
void shs256_hash(sha256 *sh, char hash[32]) { /* pad message and finish - supply digest */
  int i;
