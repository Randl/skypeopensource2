...
int update_localheader_crc_in_db(uint local_header_id, uint header_id_crc, uint remote_header_id) {
  int ret;

  debuglog("Updating localheader in db\n");
  ...
  ret = update_lh_crc_to_db(CHAT_STRING, local_header_id, header_id_crc, remote_header_id);
...
int update_remoteheader_crc_in_db(uint local_header_id, uint header_id_crc, uint remote_header_id) {
  int ret;
  ...
  // header_id_crc -- for select
  // remote_header_id -- for update
  ret = update_rh_crc_to_db(CHAT_STRING, local_header_id, header_id_crc, remote_header_id);
