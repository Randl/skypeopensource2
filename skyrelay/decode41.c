...
//cikl
  ...
  if (DEBUG)
    printf("last bytes ( 0x%02X 0x%02X 0x%02X 0x%02X )\n",
           buf_esi[0] & 0xff,
           buf_esi[1] & 0xff,
           buf_esi[2] & 0xff,
           buf_esi[3] & 0xff);
...
int mysub_call_on_reply_check_possible_Flush_decode_pkt_header_decode_fail(uint var1,
                                                                           uint var2,
                                                                           uint var3,
                                                                           uint var4,
                                                                           uint var5,
...
//mysub_some_vars_set_math_009278B0(self->value_02c3f818,ebp,self->value_02c3f844);
        ...
        int __cdecl mysub_some_vars_set_math_009278B0(int a1, u8 a2, int a3, char *selfptr) {
          int result; // eax@1
          int v4; // edx@2
          int v5; // ebx@2
          int v6; // eax@6
