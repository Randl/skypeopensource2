...
static __inline__ void SHA1_init(SHA1_state *SHA1_context) {
  SHA1_context->hash[0] = 0x67452301UL;
  SHA1_context->hash[1] = 0xEFCDAB89UL;
  SHA1_context->hash[2] = 0x98BADCFEUL;
  SHA1_context->hash[3] = 0x10325476UL;
  SHA1_context->hash[4] = 0xC3D2E1F0UL;
  SHA1_context->pos = 0;
  SHA1_context->bits[0] = 0;
  SHA1_context->bits[1] = 0;
}
