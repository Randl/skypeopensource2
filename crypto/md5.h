...
static __inline__ void MD5_init(MD5_state *MD5_context) {
  MD5_context->hash[0] = 0x67452301UL;
  MD5_context->hash[1] = 0xEFCDAB89UL;
  MD5_context->hash[2] = 0x98BADCFEUL;
  MD5_context->hash[3] = 0x10325476UL;
  MD5_context->pos = 0;
  MD5_context->bits[0] = 0;
  MD5_context->bits[1] = 0;
}
